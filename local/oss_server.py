...
#         index: Index name (optional, uses default if not specified)
#         size: Number of results to return (max 100)
#         from_: Offset for pagination
#         search_type: Type of search (match, term, wildcard, fuzzy, prefix)
#     """
#     try:
...
#             }
#         else:
#             # Default to query_string parser
#             search_body = {
#                 "query": {
#                     "query_string": {
#                         "query": query
...
#     Args:
#         document: Document content as JSON object
#         index: Index name (optional, uses default if not specified)
#         doc_id: Document ID (optional, auto-generated if not specified)
...
#         return {
#             "success": False,
#             "error": f"Document '{doc_id}' not found in index '{index}'"
#         }
#     except OpenSearchException as e:
#         return {
#             "success": False,
...
#         response = opensearch_client.client.delete(
#             index=index,
#             id=doc_id,
#             refresh=refresh
#         )
...
#         response = opensearch_client.client.indices.get_mapping(
#             index=index
#         )
...
# ) -> Dict[str, Any]:
#     """
#     Perform bulk operations (index, update, delete)

#     Args:
#         operations: List of bulk operations
#         index: Default index name for operations
...
#                     }
#                 })
#                 bulk_body.append({"doc": op["document"]})
#             elif 'delete' in op:
#                 bulk_body.append({
#                     "delete": {
#                         "_index": op.get("index", index),
...
#         response = opensearch_client.client.bulk(
#             body=bulk_body,
#             refresh=refresh
#         )
