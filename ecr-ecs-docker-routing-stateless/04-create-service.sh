...
# OpenSearch MCP Server - ECS Service Creation Script (Stateless Version)
# Creates ECS service with ALB integration for stateless deployment (max 1 task, no auto-scaling)
...
SERVICE_NAME="opensearch-mcp-server-routing-stateless"
DESIRED_COUNT=1

echo "🚀 Creating ECS service for stateless deployment..."
...
SERVICE_ARN=$(aws ecs create-service \
    ...
    --load-balancers targetGroupArn=$TARGET_GROUP_ARN,containerName=opensearch-mcp-server-routing-stateless,containerPort=9898 \
...
echo "2. Test the service at: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossserver-stateless/health"
echo ""
echo "📝 Service Configuration:"
echo "   - Max tasks: 1 (no auto-scaling)"
echo "   - Platform: Fargate"
echo "   - Port: 9898"
echo "   - Health check: /ossserver-stateless/health endpoint"