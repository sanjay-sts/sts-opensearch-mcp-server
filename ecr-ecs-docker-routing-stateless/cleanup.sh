...
# OpenSearch MCP Server - Cleanup Script (Stateless Version)
# Removes all AWS resources created for the stateless OpenSearch MCP service
...
TARGET_GROUP_NAME="opensearch-mcp-stateless-tg"
REPOSITORY_NAME="opensearch-mcp-server-stateless"
LOG_GROUP_NAME="/ecs/opensearch-mcp-server-routing-stateless"

echo "🧹 Cleaning up OpenSearch MCP Server stateless resources..."
