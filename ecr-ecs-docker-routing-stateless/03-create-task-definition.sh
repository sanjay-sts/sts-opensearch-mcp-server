...
# OpenSearch MCP Server - ECS Task Definition Creation Script (Stateless Version)
# Creates ECS task definition with the Docker image from ECR for stateless deployment
...
echo "📋 Creating ECS task definition for stateless deployment..."
