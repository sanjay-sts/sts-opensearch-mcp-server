...
# OpenSearch MCP Server - ALB Listener Rule Creation Script (Stateless Version)
# Creates ALB listener rule to route traffic to the stateless target group
...
PATH_PATTERN="/ossserver-stateless/*"  # Route all /ossserver-stateless paths to our service
PRIORITY=101  # Adjusted for stateless deployment

echo "🔗 Creating ALB listener rule for stateless deployment..."
...
echo "   Health check: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossserver-stateless/health"
echo "   MCP endpoint: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossserver-stateless/ossmcp"
echo ""
...
echo '    "opensearch": {'
echo '      "command": "npx",'
echo '      "args": ["-y", "mcp-remote", "http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossserver-stateless/ossmcp", "--allow-http"]'
echo '    }'
echo '  }'
echo '}'
echo ""
echo "📝 To test the deployment:"
echo "   curl http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossserver-stateless/health"