...
# OpenSearch MCP Server - Target Group Creation Script (Stateless Version)
# Creates ALB target group for the stateless OpenSearch MCP service
...
echo "🎯 Creating ALB target group for OpenSearch MCP Server (Stateless)..."
...
TARGET_GROUP_ARN=$(aws elbv2 create-target-group \
    ...
    --health-check-path "/ossserver-stateless/health" \
