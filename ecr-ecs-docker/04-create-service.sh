...
SERVICE_ARN=$(aws ecs create-service \
    ...
    --load-balancers targetGroupArn=$TARGET_GROUP_ARN,containerName=opensearch-mcp-server,containerPort=9898 \
...
echo "2. Test the service at: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/health"
echo ""
