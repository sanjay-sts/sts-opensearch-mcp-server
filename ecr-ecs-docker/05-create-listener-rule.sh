...
PATH_PATTERN="/ossmcp*"  # Route all /ossmcp paths to our service
...
echo "   Health check: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/health"
echo "   MCP endpoint: http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossmcp"
echo ""
...
echo '    "opensearch": {'
echo '      "command": "npx",'
echo '      "args": ["-y", "mcp-remote", "http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/ossmcp"]'
echo '    }'
echo '  }'
echo '}'
echo ""
echo "📝 To test the deployment:"
echo "   curl http://fastmcp-alb-1326912822.us-east-1.elb.amazonaws.com/health"